...
function getProgram() {
  return { startWeight: START_WEIGHT, fightDate: FIGHT_DATE,
...
function resetProgram() { START_WEIGHT = 215; DEFAULT_BLOCKS.forEach((d, i) => Object.assign(BLOCKS[i], d)); rebuildProgram(); }
...
Object.assign(window, {
  ...
  blockForDate, weekOfCamp, targetWeight, planForDate, plannedSessions,
