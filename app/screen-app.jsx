...
function App() {
  ...
  return (
    <div style={{ height: '100%', background: T.bg2, display: 'flex', justifyContent: 'center', alignItems: 'stretch' }}>
      <div style={{ position: 'relative', width: '100%', maxWidth: 520, height: '100%', background: T.bg, display: 'flex', flexDirection: 'column', boxShadow: '0 0 80px rgba(0,0,0,0.5)', overflow: 'hidden' }}>
        <div ref={scrollRef} style={{ flex: 1, minHeight: 0, overflowY: 'auto', overflowX: 'hidden', padding: 'calc(18px + env(safe-area-inset-top)) 18px 26px', color: T.text, fontFamily: T.font }}>
          {screens[screen]}
        </div>
