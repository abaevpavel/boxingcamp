...
function seedState() {
  ...
  return {
    ...
    weights: [
      { date: '2026-05-18', weightLb: 217.4, bodyFatPct: 22.5 },
      { date: '2026-05-19', weightLb: 217.0, bodyFatPct: null },
      { date: '2026-05-20', weightLb: 216.6, bodyFatPct: null },
      { date: '2026-05-21', weightLb: 216.8, bodyFatPct: null },
      { date: '2026-05-22', weightLb: 216.1, bodyFatPct: null },
      { date: '2026-05-23', weightLb: 215.9, bodyFatPct: null },
      { date: '2026-05-24', weightLb: 216.0, bodyFatPct: null },
      { date: '2026-05-25', weightLb: 215.6, bodyFatPct: 22.1 },
      { date: '2026-05-26', weightLb: 215.3, bodyFatPct: null },
      { date: '2026-05-27', weightLb: 215.0, bodyFatPct: null },
      { date: '2026-05-28', weightLb: 215.1, bodyFatPct: null },
      { date: '2026-05-29', weightLb: 214.6, bodyFatPct: 21.8 },
    ],
    checkIns: [],
    benchmarks: [
...
function daySessions(dateISO, state) {
  ...
  rows.sort((a, b) => window.TYPE_ORDER.indexOf(a.type) - window.TYPE_ORDER.indexOf(b.type));
  return rows;
}
